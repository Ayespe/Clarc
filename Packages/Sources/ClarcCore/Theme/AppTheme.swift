...
extension ThemeColors {
    public static let claude: ThemeColors = {
        ...
        return ThemeColors(
            ...
            background:           Color(light: .hex(0xF5F4EF), dark: .hex(0x1E1E1C)),
            surfacePrimary:       Color(light: .hex(0xEDEAE0), dark: .hex(0x2A2A26)),
            surfaceSecondary:     Color(light: .hex(0xE5E2D9), dark: .hex(0x34342F)),
            surfaceTertiary:      Color(light: .hex(0xDDDAD2), dark: .hex(0x41413A)),
            surfaceElevated:      Color(light: .hex(0xFAF9F6), dark: .hex(0x2F2F2B)),
            sidebarBackground:    Color(light: .hex(0xEDEAE2), dark: .hex(0x191918)),
            sidebarItemHover:     Color(light: .hex(0xE0DDD4), dark: .hex(0x292925)),
            sidebarItemSelected:  Color(light: .hex(0xD97757).opacity(0.12), dark: .hex(0xD97757).opacity(0.15)),
            textPrimary:          Color(light: .hex(0x3C3929), dark: .hex(0xECE8DE)),
            textSecondary:        Color(light: .hex(0x6B6960), dark: .hex(0xC0BBB0)),
            textTertiary:         Color(light: .hex(0x9A978E), dark: .hex(0x918C82)),
            border:               Color(light: .hex(0xD5D2C8), dark: .hex(0x4C4C44)),
            borderSubtle:         Color(light: .hex(0xE0DDD4), dark: .hex(0x353530)),
            codeBackground:       Color(light: .hex(0xE8E5DC), dark: .hex(0x171716)),
            codeHeaderBackground: Color(light: .hex(0xDDD9CF), dark: .hex(0x252522)),
            userBubble:           Color(light: .hex(0x3C3929), dark: .hex(0x3D3D37)),
            userBubbleText:       Color(light: .hex(0xF5F4EF), dark: .hex(0xF1EEE5)),
            assistantBubble:      Color(light: .hex(0xE8E5DC), dark: .hex(0x2A2A26)),
            ...
            inputBackground:      Color(light: .hex(0xFAF9F6), dark: .hex(0x2A2A26)),
            inputBorder:          Color(light: .hex(0xD5D2C8), dark: .hex(0x515149))
        )
    }()
}
