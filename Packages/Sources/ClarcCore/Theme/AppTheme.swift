...
extension ThemeColors {
    public static let claude: ThemeColors = {
        ...
        return ThemeColors(
            ...
            background:           Color(light: .hex(0xF5F4EF), dark: .hex(0x262623)),
            surfacePrimary:       Color(light: .hex(0xEDEAE0), dark: .hex(0x30302C)),
            surfaceSecondary:     Color(light: .hex(0xE5E2D9), dark: .hex(0x393934)),
            surfaceTertiary:      Color(light: .hex(0xDDDAD2), dark: .hex(0x464640)),
            surfaceElevated:      Color(light: .hex(0xFAF9F6), dark: .hex(0x33332F)),
            sidebarBackground:    Color(light: .hex(0xEDEAE2), dark: .hex(0x22221F)),
            sidebarItemHover:     Color(light: .hex(0xE0DDD4), dark: .hex(0x30302C)),
            sidebarItemSelected:  Color(light: .hex(0xD97757).opacity(0.12), dark: .hex(0xD97757).opacity(0.15)),
            textPrimary:          Color(light: .hex(0x3C3929), dark: .hex(0xE1DED5)),
            textSecondary:        Color(light: .hex(0x6B6960), dark: .hex(0xB5B1A7)),
            textTertiary:         Color(light: .hex(0x9A978E), dark: .hex(0x918D84)),
            border:               Color(light: .hex(0xD5D2C8), dark: .hex(0x494943)),
            borderSubtle:         Color(light: .hex(0xE0DDD4), dark: .hex(0x363631)),
            codeBackground:       Color(light: .hex(0xE8E5DC), dark: .hex(0x1F1F1D)),
            codeHeaderBackground: Color(light: .hex(0xDDD9CF), dark: .hex(0x2B2B28)),
            userBubble:           Color(light: .hex(0x3C3929), dark: .hex(0x464640)),
            userBubbleText:       Color(light: .hex(0xF5F4EF), dark: .hex(0xF1EEE5)),
            assistantBubble:      Color(light: .hex(0xE8E5DC), dark: .hex(0x30302C)),
            ...
            inputBackground:      Color(light: .hex(0xFAF9F6), dark: .hex(0x30302C)),
            inputBorder:          Color(light: .hex(0xD5D2C8), dark: .hex(0x494943))
        )
    }()
}
